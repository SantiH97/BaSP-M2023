...
var myArr = ["primera", "segunda", "tercera", "cuarta", "quinta"];
...
for (var i = 0; i < myArr.length; i++) {
    var answer = myArr[i];
    var capitalize = answer.substring(0, 1);
    var rest = answer.substring(1);
    capitalize = capitalize.toUpperCase();
    alert(capitalize + rest + "!");
}
...
/* d. Crear un array vacío y con un bucle for de 10 repeticiones.
 ...
 debería haber 10 elementos dentro del array, desde el número 0 hasta al número 9. Mostrar por la consola del navegador
